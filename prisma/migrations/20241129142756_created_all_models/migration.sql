...
-- AddForeignKey
ALTER TABLE "DaysAvailability" ADD CONSTRAINT "DaysAvailability_availability_fkey" FOREIGN KEY ("availability") REFERENCES "Availability"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
